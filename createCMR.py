...
# message_text = ""
# stamp_present = "CMR накладная создана успешно! Штамп установлен"
# stamp_absent = "CMR накладная создана успешно! Штамп отсутствует, загрузите файл штампа"
#
...
#
#             # Проверка наличия файла штампа перед его добавлением
...
#                 message_text = stamp_present
#             else:
#                 message_text = stamp_absent
#
#         can.showPage()
#         can.save()
#
...
#     create_cmr_from_template("DokumentCMR.pdf", output_file, data)
#
